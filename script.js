...
if(chatbox.classList.contains("active-chat-box")){
 ...
 let Api_url= "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyBmTfKIeF-2ATN9wTcft3JPMJ9di7x0OzM"
...
if(message.includes("open") && message.includes("chat")){
  ...
  speak("hello Team,what can i help you?")
}
else if(message.includes("who are you")){
  speak("i am virtual assistant ,created by Tech titan team")
...
speak(time)
  ...
  let finalText="this is what i found on internet regarding" + message.replace("Titan team","") || message.replace("Titan team","")
  speak(finalText)
  window.open(`https://www.google.com/search?q=${message.replace("Titan team","")}`,"_blank")
}
}
